...
export function Achievements() {
  const achievements = [
    ...
    },
    {
      ...
      year: '2022-2025',
      title: 'Dean\'s List',
      description: 'Maintained GPA above 1.2 - 1.78 for three consecutive years, earning Dean\'s List honors.',
    },
  ];

  return (
    <section className="min-h-screen bg-[#000000] py-24">
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div className="bg-[#474747] p-3 border border-[#919191]">
                      <Icon className="w-6 h-6 text-[#CECECE]" />
                    </div>
                    <span className="text-sm text-[#919191]">{achievement.year}</span>
                  </div>
                  
                  <div className="space-y-3">
                    <p className="text-sm text-[#919191]">{achievement.category}</p>
